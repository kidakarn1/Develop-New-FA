...
Public Class print_back
	...
	Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
		...
		Dim api = New api()
		Dim load_data = api.Load_data("http://192.168.161.207/API_NEW_FA/GET_DATA_NEW_FA/GET_DATA_WORKING?WI=" & Prd_detail.lb_wi.Text)
	...
	Private Sub PrintDocument2_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument2.PrintPage
		...
		'MsgBox("qr code ===> " & qr_code)
		Dim id_tag = api.Load_data("http://192.168.161.207/API_NEW_FA/GET_DATA_NEW_FA/GET_ID_PRINT_DETAIL?qr_code=" & qr_code)
		'MsgBox("id_tag = " & id_tag)
		'For K = 1 To 5 Step 1
		'Backoffice_model.Insert_tag_print_sub(id_tag, MainFrm.Label4.Text, arr_qr_code_sub(K - 1))
		'Next
	End Sub
End Class
